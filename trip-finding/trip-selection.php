...
<body>
    ...
    <main>
        <a href="trip-description.php">
            <div class="trip-container">
                <div>
                    <!-- code image dans test-bdd -->
                ...
                <div class="trip-info">
                    <div class="col" id="col1">
                        ...
                        <div class="line-container">
                            <div class="line-hor" id="line-color-white"></div>
                            <div class="point center-item-col">
                                <div class="circle-bg">
                                    <div class="circle-upper"></div>
                                </div>
                            </div>
                            <div class="line-hor" id="line-color-green"></div>
                        </div>
        ...
        <?php
        foreach ($trips as $trip) {
            // faire la méthode GET dans le a href
            echo '<a href="trip-description.php"><div class="trip-container">';
            echo '<div><img src="../images/utilisateur.png" class="img-user"></div>';
            echo '<div><span>' . $trip['nom'] . '</span>';
            ...
            echo '<div class="col" id="col1"><div class="dep center-item-col">départure</div> <div class="line-container"><div class="line-hor" id="line-color-white"></div><div class="point center-item-col"><div class="circle-bg"><div class="circle-upper"></div></div></div><div class="line-hor" id="line-color-green"></div></div><div class="hour center-item-col">' . $trip['timeDepart'] . '</div></div>';
            echo '<div class="col-flex" id="col2"><div class="trait-horizontal"></div></div>';
            echo '<div class="col" id="col3"><div class="arr center-item-col">arrivée</div><div class="line-container"><div class="line-hor" id="line-color-green"></div><div class="point center-item-col"><div class="circle-bg"><div class="circle-upper"></div></div></div><div class="line-hor" id="line-color-white"></div></div><div class="hour center-item-col">' . $trip['timeDepart'] . '</div></div>';
            echo '</div></div></a>';
        }
