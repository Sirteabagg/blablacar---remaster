...
<footer>
    <nav>
        <div class="nav-container">
            <div class="nav-item">
                <a href="<?php echo BASE_URL; ?>/trip-finding/php/trip-ressources/trip-form.php">
            ...
            <div class="nav-item">
                <a href="<?php echo BASE_URL; ?>/create-trip/create-trip.php">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50" style="fill: white;">
            ...
            <div class="nav-item">
                <a href="<?php echo BASE_URL; ?>/trajet/trajet.php">
            ...
            <div class="nav-item">
                <a href="<?php echo BASE_URL; ?>/profil/php/profilforme.php">
