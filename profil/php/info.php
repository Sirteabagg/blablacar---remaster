        ...
        <form action="" method="post">
            ...
            <div class="grid">
                <div class="case">
                    ...
                    <input type="password" class="form-input2" id="current_password" name="current_password" required>
                </div>
                <div class="case">
                    <label for="new_password">Nouveau mot de passe :</label>
                    <input type="password" class="form-input2" id="new_password" name="new_password" required>
                </div>
                <div class="case">
                    <label for="confirm_password">Nouveau mot de passe :</label>
                    <input type="password" class="form-input2" id="confirm_password" name="confirm_password" required>
                </div>
