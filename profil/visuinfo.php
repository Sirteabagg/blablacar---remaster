...
<div class="container">
    <div class="menup">
        <div class="item titre">Bonjour, Alex !</div>
        <div class="item ID">
    ...
    <div class="forme">
        ...
        <div class="s2"><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="30px" height="30px" viewBox="0 0 1208.000000 1280.000000"
